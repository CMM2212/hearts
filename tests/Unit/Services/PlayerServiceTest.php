...
class PlayerServiceTest extends TestCase
{
    ...
    public function testGetCardsToPass()
    {
        ...
        $hand = Hand::factory()->create(['gameplayer_id' => $gamePlayer->id, 'round_id' => $round->id]);
        $hand2 = Hand::factory()->create(['gameplayer_id' => $gamePlayer2->id, 'round_id' => $round->id]);
        CardHand::factory()->count(5)->create(['hand_id' => $hand->id, 'from_hand_id' => null]);
        CardHand::factory()->count(5)->create(['hand_id' => $hand->id, 'from_hand_id' => $hand2->id]);
